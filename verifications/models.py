...
class Verification(models.Model):
    ...
    cert_num = models.CharField(max_length=150, blank=False, null=True)
    email = models.CharField(max_length=50, blank=False, null=True)
    slug = models.CharField(max_length=200, blank=False, null=True, unique=True)
    make = models.CharField(max_length=150, blank=False, null=True)
